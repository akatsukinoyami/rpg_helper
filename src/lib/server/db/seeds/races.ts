export const racesSeed = [
	...
	{
		name: 'Эльф',
		description: 'Изящные и долгоживущие, эльфы обладают природным сродством с магией и дикой природой.',
	...
	{
		name: 'Полурослик',
		description: 'Маленькие и проворные, полурослики — удачливые странники с умением избегать неприятностей.',
	...
	{
		name: 'Неко',
		description: 'Кошколюди с кошачьей грацией, острыми инстинктами и неотразимым обаянием. Любопытные и непредсказуемые.',
		baseStats: { str: 7, dex: 15, con: 8, int: 10, wis: 11, cha: 13 },
		startingSkills: ['Stealth', 'Acrobatics']
	},
	{
		name: 'Инуко',
		description: 'Собаколюди, известные преданностью, неиссякаемой энергией и острыми чувствами. Прирождённые вожаки стаи.',
		baseStats: { str: 12, dex: 12, con: 11, int: 9, wis: 13, cha: 11 },
		startingSkills: ['Perception', 'Athletics']
	},
	{
		name: 'Гарпия',
		description: 'Крылатые птицелюди с острым зрением и стремительными движениями. Гордые и свободолюбивые.',
		baseStats: { str: 8, dex: 15, con: 8, int: 10, wis: 14, cha: 10 },
		startingSkills: ['Perception', 'Acrobatics']
	},
	{
		name: 'Ламия',
		description: 'Змеелюди с мощным телом и завораживающим взглядом. Древние, терпеливые и гипнотически убедительные.',
		baseStats: { str: 13, dex: 11, con: 13, int: 10, wis: 9, cha: 14 },
		startingSkills: ['Intimidation', 'Persuasion']
	},
	{
		name: 'Дракониды',
		description: 'Воины с драконьей кровью: чешуя, когти и врождённое владение древней магией. Гордые и могущественные.',
		baseStats: { str: 14, dex: 8, con: 13, int: 12, wis: 9, cha: 10 },
		startingSkills: ['Intimidation', 'Arcana']
	},
	{
		name: 'Ангел',
		description: 'Небесные существа лучистого света и божественной мудрости. Сострадательные и справедливые.',
		baseStats: { str: 10, dex: 11, con: 10, int: 13, wis: 15, cha: 13 },
		startingSkills: ['Medicine', 'Persuasion']
	},
	{
		name: 'Демон',
		description: 'Инфернальные существа грубой силы и хитрых амбиций. Мастера страха и желания, процветающие в хаосе.',
		baseStats: { str: 14, dex: 11, con: 12, int: 13, wis: 7, cha: 12 },
		startingSkills: ['Intimidation', 'Arcana']
	},
	{
		name: 'Суккуб / Инкуб',
		description: 'Демоны желания с неотразимым обаянием и серебряным языком. Хрупкие телом, но опустошительно эффективные через очарование.',
